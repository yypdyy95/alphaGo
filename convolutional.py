...
model = Sequential()
model.add(Convolution2D(48, 5,5, input_shape=(number_of_planes, 19, 19), border_mode='same', activation='relu'))
...
history = model.fit(x_train, y_train, nb_epoch=10, batch_size=512, validation_split = 0.05)

util.visualize_weights(model.layers[0], 8)
